...
import com.vectorization.core.database.SpaceFactory;
import com.vectorization.core.database.VantagePointForestSpaceFactory;

public class NodeDatabase implements Database {
	...
	public NodeDatabase(String databaseName, SpaceFactory factory) {
	...
	public Database remove(String space, String... vectorIds) {
